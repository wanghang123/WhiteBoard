...
public class WpsModel {
    ...
    // WPS文档的activity
    public static final String WORD_WPS = "cn.wps.moffice.writer.multiactivity.Writer1";
    public static final String EXCEL_WPS = "cn.wps.moffice.spreadsheet.multiactivity.Spreadsheet1";
    public static final String PPT_WPS = "cn.wps.moffice.presentation.multiactivity.Presentation1";
    public static final String PDF_WPS = "cn.wps.moffice.pdf.multiactivity.PDFReader1";

    public static final String[] WPS_DOCS = new String[]{WORD_WPS, EXCEL_WPS, PPT_WPS, PDF_WPS};
